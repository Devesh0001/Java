...
public class AddDrivers extends JFrame implements ActionListener
{
	...
	public AddDrivers() 
	{
		...
		Image img=new ImageIcon(this.getClass().getResource("/opening-door-to-car.jpg")).getImage();
		lblNewLabel.setIcon(new ImageIcon(img));
        lblNewLabel.setBounds(395, 53, 579, 335);
	...
	public void actionPerformed(ActionEvent ae)
	{
        ...
        if(name.trim().equals("") || age.trim().equals("") || gender.trim().equals("") || company.trim().equals("") || brand.trim().equals("") || available.trim().equals("")|| location.trim().equals(""))
        {
