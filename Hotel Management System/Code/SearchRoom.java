...
public class SearchRoom extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
			String SQL = "select * from roomtable where BedType = '"+c1.getSelectedItem()+"'";
			String SQL2 = "select * from roomtable where Availability = 'Available' AND BedType = '"+c1.getSelectedItem()+"'";
		try
		{			
