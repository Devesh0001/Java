...
<html>
      ...
      <script type="text/javascript">
           		...
           		function populate(s1,s2){
           			...
           			if(s1.value == "General"){
           				...
           				var optionArr=["|----Category Id----","S001|S001-Maths","S002|S002-Physics","S003|S003-Chemistry","S004|S004-Physcology","S005|S005-English"];
           				for(var option in optionArr){
               				var pair =optionArr[option].split("|");
               				var newoption=document.createElement("option");
               				newoption.value=pair[0];
    ...
    <body style="background-color:#c3e8fa;">
        <div id="logreg-forms" >
        <form class="form-signin" action="ExamRegister0" method="get">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Exam Registration Form</h1>
            <hr>
            <input type="text" id="inputEmail" class="form-control" placeholder="UserID" name="uid" value=${uId} ><br/>
           ...
           <select class="form-control" required name="Category Id" id="CategoryId">
			...
			<input class="btn btn-success btn-block" type="submit" value="Next" style="color:white;"><br/>
            <a href="UserHome.jsp" id="forgot_pswd"  style="text-align: center;">Back To Profile</a><br/>
            <h5 style="color:red; text-align: center;">${examreg}</h5>
            <hr>
        </form>  
        </div>
