...
<html>
    <head>
        ...
        <title>View Category & Ques</title>
        <style>
    ...
    <body style="background-color:#c3e8fa;">
        <div id="logreg-forms" >
        <form class="form-signin" action="ViewCategoryandQues" method="get">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Select Category</h1>
            <hr>
