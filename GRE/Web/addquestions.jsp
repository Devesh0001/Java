...
@media screen and (max-width:500px){
    ...
    <body>
            ...
            <h5 style="text-align: center;">Add Questions to Examination</h5><br/>
                        
            <form class="form-signin" action="addquestionDB" method="POST">
             	<input type="text" class="form-control" placeholder="Category Id" name="catid" readonly value=${CategoryId}>
                ...
                <h5 style="color:red; text-align: center;">${quescon}</h5>
            </form>
    </body>
</html>