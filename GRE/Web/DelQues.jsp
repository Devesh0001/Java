...
<html>
    ...
    <body style="background-color:#c3e8fa;">
        <div id="logreg-forms" >
        <form class="form-signin" action="selectquesfordel" method="get">
            <h1 class="h3 mb-3 font-weight-normal" style="text-align: center">Select Question to delete</h1>
            <hr>
			...
			<h5 style="color:red; text-align: center;">${delcon}</h5>
            <hr>
